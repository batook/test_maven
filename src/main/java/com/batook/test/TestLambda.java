...
class TestLambda {
    public static void main(String[] args) {
        ...
        BiFunction<String, String, Integer> bf = (s1, s2) -> s1.concat(s2)
                                                               .length();
        ...
        OptionalDouble opt = new Random().ints(1, 100)
                                         .limit(10)
                                         .average();
        ...
        System.out.println("union " + Stream.concat(i1.stream(), i2.stream())
                                            .collect(Collectors.toSet()));
        System.out.println("intersect " + i1.stream()
                                            .filter(i2::contains)
                                            .collect(Collectors.toSet()));
        ...
        System.out.println(Stream.of("2", "3", "0", "1", "3")
                                 .collect(Collectors.averagingInt(n -> Integer.parseInt(n))));
        System.out.println(Stream.of(1, 3, 0, 1, 3, 2)
